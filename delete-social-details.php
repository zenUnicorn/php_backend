...
if (isset($_POST['update_order'])) {
    ...
    $update_order = "DELETE FROM social_details WHERE id='$id'";
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <h5 class="card-title">Delete details</h5>
                            <?php
                            if(isset($_GET['id']))
                                {
                                    $detail_id = $_GET['id'];
                                    $sqli = "SELECT * FROM social_details WHERE id='$detail_id'";
                                ...
                                <form action="#" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" name="status" value="<?=$detail["status"];?>" class="form-control" id="">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <button name="update_order" class="btn btn-danger">Delete</button>
                                            </div>
                                        </div>
                                </form>
