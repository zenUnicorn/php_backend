...
<head>
    ...
    <title>Environ Platform | withdraw page</title>
    <!-- Favicon icon -->
...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <?php
            $user_id = $_SESSION['id'];
            $sqli = "SELECT * FROM withdrawal_table  WHERE user_id = $user_id ORDER BY id DESC LIMIT 1";
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-body printableArea">
                            ...
                            <h3><b>Withdrawal Successful! <span class="fa fa-check-circle"></span></b> <span class="pull-right"></span></h3>
                            <hr>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pull-left">
                                    ...
                                    <div class="pull-right text-end">
                                        <address>
                                            <h3>To: <?php echo  $_SESSION['full_name']; ?>,</h3>
                                            <h4 class="font-bold">Account ID: <?php echo $row["account_id"] ?></h4>
                                            
                                            <p class="mt-4"><b>Withdraw Date/Time: </b><?php echo $row["withdraw_time"] ?></p>
                                ...
                                <div class="col-md-12">
                                    <div class="table-responsive mt-5" style="clear: both;">
                                        <table class="table table-hover">
                                            <thead>
                                                <tr>
                                                    <th class="text-center"><b>Package</b></th>
                                                    <th><b>Wallet Address</b></th>
                                                    <th><b>Amount withdrawn</b></th>
                                                    <th class="text-end" hidden><b>Amount withdrawable</b></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-end" hidden><?php echo $row["total"] ?> </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="pull-right mt-4 text-end">
                                        <p>Withdrawal charges (0%) : $0 </p>
                                        <hr>
                                        <h3><b>Total :</b> <?php echo $row["amount"] ?></h3>
                                    </div>
                                    <div class="clearfix"></div>
                                    <hr>
                                    <div class="text-end">
                                        <a href="user-dashboard.php">
                                            <button class="btn btn-danger text-white" type="submit"> Dashboard </button>
                                        </a>
                                    </div>
                                </div>
                            </div>
