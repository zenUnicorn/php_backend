                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <?php while ($row = $resulti->fetch_assoc()) {  ?>
                                                ...
                                                <td><a href="edit-social-details.php?id=<?= $row["id"]?>" class="btn btn-success" style="color: #fff;">Edit</a></td>
                                                <td><a href="delete-social-details.php?id=<?= $row["id"]?>" class="btn btn-danger" style="color: #fff;">Delete</a></td>
