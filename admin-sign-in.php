...
<?php
   ...
   if(isset($_POST['login_button'])) {
       ...
       $sql = "SELECT * FROM `admin_table` WHERE admin_username = '{$email_signin}' AND admin_password = '{$password_signin}' ";
            ...
            <div class="inner-block">
                <form action="#" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="email_signin" id="email_signin" placeholder="admin" required />
                    </div>
                    <div class="form-group">
