...
<head>
    ...
    <title>Environ Platform | Referral</title>
    <!-- Favicon icon -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p>We are currently working on the system reward system, which is going to help give back to our investors,
                                    by saying a big thank you to them for truusting our platform. The reward system is basically a refer and earn
                                    program, where you get to share your unique referral code with a friend t sign up and buy a package on Environ Platform
                                </p>
                                <p>The Referral program:</p>
                                <ol>
                                    <li><b>Get a referral link</b>: After you have successfully registrated, you can request for a referral link and it will be generated your personal
                                        account.</li>
                                    <li>
                                    <b>Share referral link</b>: You can share information about our company with friends, partners, site visitors or other
                                        audience.
                                    </li>
                                    <li>
                                    <b>Get your reward</b>: Receive up to 9% of purchases made by customers registered with your link.
                                    </li>
                                </ol>
                            </div>
                        </div>
