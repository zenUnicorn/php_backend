...
if (isset($_POST['update_details'])) {
    ...
    $update_order = "UPDATE staff_tasks SET name='$name', task='$task', completed='$completed' WHERE id='$user_id'";
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <h5 class="card-title">Edit all taska</h5>
                            <?php
                            if(isset($_GET['id']))
                                {
                                    $user_id = $_GET['id'];
                                    $sqli = "SELECT * FROM staff_tasks WHERE id='$user_id'";
                                ...
                                <form action="#" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" name="user_id" value="<?=$detail["user_id"];?>" class="form-control" id="">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <label for="name">Name</label>
                                                <input type="text" name="name" value="<?=$detail["name"];?>" class="form-control" id="">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <label for="name">Task</label>
                                                <input type="text" name="task" value="<?=$detail["task"];?>" class="form-control" id="">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
